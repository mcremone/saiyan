...
mu_ntot = mu.counts
mu_nloose = mu[mu.isloose].counts
...
pho_ntot=pho.counts
pho_nloose=pho[pho.isloose].counts
...
fj_ntot=fj.counts
fj_ngood=fj[fj.isgood].counts
fj_nclean=fj[fj.isclean].counts
...
j_ntot=j.counts
j_ngood=j[j.isgood].counts
j_nclean=j[j.isclean].counts
j_niso=j[j.isiso].counts
